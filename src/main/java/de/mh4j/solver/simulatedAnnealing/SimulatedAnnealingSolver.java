...
public class SimulatedAnnealingSolver<GenericSolutionType extends Solution> extends AbstractSimulatedAnnealingSolver<GenericSolutionType> {
	...
	public SimulatedAnnealingSolver(AbstractCoolingScheme<GenericSolutionType> coolingScheme,
			NeighborFunction<GenericSolutionType> neighborFunction,
			int numberOfConsecutiveSteadyStepsUntilTermination) {
		this(coolingScheme, neighborFunction, numberOfConsecutiveSteadyStepsUntilTermination, System.currentTimeMillis());		
	}

	public SimulatedAnnealingSolver(AbstractCoolingScheme<GenericSolutionType> coolingScheme,
			NeighborFunction<GenericSolutionType> neighborFunction,
			int numberOfConsecutiveSteadyStepsUntilTermination, long seed) {
